...
//   - Add a clearData flag that allows to disable deletion of existing data
//   - Make preAllocSize larger, see explanation inline
//
...
public class MiniZooKeeperCluster {
  ...
  private static void setupTestEnv() {
	...
	// throws a CRC error reading the log. Not sure why, as this pre-allocation should only be an optimization.
    System.setProperty("zookeeper.preAllocSize", String.valueOf(8291 *1024));
