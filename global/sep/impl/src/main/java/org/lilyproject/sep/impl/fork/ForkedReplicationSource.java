 ...
 */
package org.lilyproject.sep.impl.fork;
 ...
 * to changes in the number of regionservers in peer clusters. Once HBASE-7634 is in place then this class can be
 * removed.
 * 
 * All lily-specific changes are marked with "lily change".
 * 
 * If a new version of HBase is used (and HBASE-7634 is not available in it), the changes marked with "lily change"
 * should be applied to the new forked version of the class.
 * 
...
public class ForkedReplicationSource extends Thread implements ReplicationSourceInterface {
    ...
    // lily change - The time when the list of sinks was last read
    private volatile long sinkListReadTimetamp;
    
    // lily change - The time when the list of sinks was last changed in ZooKeeper
    ...
    /**
     * lily change - This method is added to allow being more responsive to peer cluster regionserver changes.
     * @throws IOException
     */
    ...
    protected void shipEdits(boolean currentWALisBeingWrittenTo) {
        ...
        // lily change - if the peer regionserver list has been updated in ZooKeeper more recently than
    ...
    /**
     * lily change - this class is added to allow being more responsive to changes in the list of region servers in a
     * peer cluster.
     * 
