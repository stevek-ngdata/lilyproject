...
public class HadoopLauncher extends BaseCliTool {
    ...
    public int run(CommandLine cmd) throws Exception {
        ...
        baseTempDir = TestHomeUtil.createTestHome();

        org.lilyproject.testfw.fork.HBaseTestingUtility testUtil = HBaseTestingUtilityFactory.create(conf, baseTempDir);
        ...
        System.out.println("conf.set(\"mapred.job.tracker\", \"localhost:" + testUtil.getMRCluster().getJobTrackerPort() + "\");");
        System.out.println("Job job = new Job(conf);");
        System.out.println();
        System.out.println("JobTracker web ui:   http://localhost:" + testUtil.getMRCluster().getJobTrackerRunner().getJobTrackerInfoPort());
        System.out.println("HDFS web ui:         http://" + conf.get("dfs.http.address"));
        System.out.println("HBase master web ui: http://localhost:" + testUtil.getHBaseCluster().getMaster().getInfoServer().getPort());
        System.out.println("-------------------------");
