...
public class ListRowLogsCli extends BaseRowLogAdminCli {
    ...
    public static void main(String[] args) throws InterruptedException {
        ListRowLogsCli listRowLogsCli = new ListRowLogsCli();
        listRowLogsCli.start(args);
    }
    ...
    public int run(CommandLine cmd) throws Exception {
        ...
        for (Entry<String, RowLogConfig> rowLog : rowLogs.entrySet()) {
            ...
            for (RowLogSubscription subscription : subscriptions) {
                ...
                System.out.println();
                List<String> listeners = rowLogConfigurationManager.getListeners(rowLog.getKey(), subscription.getId());
