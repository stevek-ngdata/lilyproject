...
public interface EntityWriter<T> {
    ObjectNode toJson(T entity, WriteOptions options, LRepository repository) throws RepositoryException,
     ...
     * object).
     */
    ObjectNode toJson(T entity, WriteOptions options, Namespaces namespaces, LRepository repository)
