 ...
 */
package org.kauriproject.xml.dom;
...
import org.kauriproject.xml.sax.*;
 ...
 * </ul>
 *
 * <p>Origin notice: this class was copied from Apache Cocoon.</p>
 */
public class DOMStreamer {
    ...
    public void setConsumer(XmlConsumer consumer) {
        defaultDOMStreamer.setConsumer(consumer);
        namespaceNormalizingDOMStreamer.setConsumer(consumer);
    }

    public void setContentHandler(ContentHandler contentHandler) {
        defaultDOMStreamer.setContentHandler(contentHandler);
        namespaceNormalizingDOMStreamer.setContentHandler(contentHandler);
    }

    public void setLexicalHandler(LexicalHandler lexicalHandler) {
        defaultDOMStreamer.setLexicalHandler(lexicalHandler);
            ...
            switch (node.getNodeType()) {
                ...
                case Node.ELEMENT_NODE:
                    ...
                    if (currentElementInfo.namespaceDeclarations != null && currentElementInfo.namespaceDeclarations.size() > 0) {
                        for (Map.Entry<String, String> entry : currentElementInfo.namespaceDeclarations.entrySet()) {
    ...
    public static class DefaultDOMStreamer extends AbstractXmlProducer {
        ...
        throws SAXException {
            ...
            if (node.getNodeType() == Node.DOCUMENT_NODE) {
                ...
                handler = new EmbedXmlFilter(contentHandler);
            }
