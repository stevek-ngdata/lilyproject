...
/**
 * Implementation of a "parameter" template instruction (nested in a "macro" instruction).
 */
public class ParameterBlock extends TemplateBlock {
    ...
    public ParameterBlock(boolean overwrite, ELFacade elFacade, SaxElement saxElement) {
        super(saxElement);
    ...
    class StartStep extends Step {
        ...
        public StartStep(Locator locator) {
            ...
            valueExpr = elFacade.createExpression(valueAttr, Object.class);
        }
        ...
        public Step executeAndProceed(ExecutionContext context, TemplateResult result) {
            ...
            if (valueExpr != null) {
                if (overwrite || !tmplContext.containsKey(name)) {
                    final Object value = valueExpr.evaluate(context.getTemplateContext());
