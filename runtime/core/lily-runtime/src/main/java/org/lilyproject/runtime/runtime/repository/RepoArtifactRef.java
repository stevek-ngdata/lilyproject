...
public class RepoArtifactRef extends BaseArtifactRef {
    ...
    public File resolve(ArtifactRepository repository) throws ArtifactNotFoundException {
        return repository.resolve(groupId, artifactId, classifier, getVersion());
    }

    public String toString() {
        return groupId + ":" + artifactId + ":" + classifier + ":" + getVersion();
    }

    public ArtifactRef clone(String version) {
        return new RepoArtifactRef(groupId, artifactId, classifier, version);
    }
}
