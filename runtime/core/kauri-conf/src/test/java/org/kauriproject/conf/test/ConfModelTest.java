package org.kauriproject.conf.test;
...
public class ConfModelTest extends TestCase {
    public void testConfig1() throws Exception {
        String configPath = "org/kauriproject/conf/test/config1.xml";
    ...
    public void testConfig2() throws Exception {
        String configPath = "org/kauriproject/conf/test/config2.xml";
        InputStream configStream = getClass().getClassLoader().getResourceAsStream(configPath);
    ...
    public void testConfig3() throws Exception {
        String configPath = "org/kauriproject/conf/test/config3.xml";
        InputStream configStream = getClass().getClassLoader().getResourceAsStream(configPath);
    ...
    public void testConfig4() throws Exception {
        String configPath = "org/kauriproject/conf/test/config4.xml";
        InputStream configStream = getClass().getClassLoader().getResourceAsStream(configPath);
    ...
    public void testConfig5() throws Exception {
        String configPath = "org/kauriproject/conf/test/config5.xml";
        InputStream configStream = getClass().getClassLoader().getResourceAsStream(configPath);
