...
public class JavaServiceWiringTest extends AbstractRuntimeTest {
    protected KauriRuntimeModel getRuntimeModel() throws Exception {
        ...
        {
            File module1Dir = createModule("org.kauriproject.runtime.test.testmodules.jwiringmod1");
        ...
        {
            File module2Dir = createModule("org.kauriproject.runtime.test.testmodules.jwiringmod2");
        ...
        {
            File module3Dir = createModule("org.kauriproject.runtime.test.testmodules.jwiringmod3");
        ...
        {
            File module4Dir = createModule("org.kauriproject.runtime.test.testmodules.jwiringmod4");
