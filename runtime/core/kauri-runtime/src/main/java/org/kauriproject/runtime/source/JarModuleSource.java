...
public class JarModuleSource implements ModuleSource {
    ...
    private static final String RESOURCES_PATH = "KAURI-INF/";
    private static final Pattern SPRING_COMMON_CONF_PATTERN = Pattern.compile("KAURI-INF/spring/[^/]*\\.xml");
    private static final String KAURI_CLASSLOADER_CONF = "KAURI-INF/classloader.xml";
    ...
    public List<SpringConfigEntry> getSpringConfigs(Mode mode) {
        Pattern modeSpecificSpringPattern = Pattern.compile("KAURI-INF/spring/" + mode.getName() + "/[^/]*\\.xml");
