...
public class RuntimeCliLauncher {
    ...
    public void run(String[] args) throws Throwable {
        ...
        ClassLoader classLoader = LauncherClasspathHelper.getClassLoader("org/kauriproject/launcher/classloader.xml", repositoryLocation);
        Thread.currentThread().setContextClassLoader(classLoader);

        Method mainMethod;
        try {
            Class runtimeClass = classLoader.loadClass("org.kauriproject.runtime.cli.KauriRuntimeCli");
