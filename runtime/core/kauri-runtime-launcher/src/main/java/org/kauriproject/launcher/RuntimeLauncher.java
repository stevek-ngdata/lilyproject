 ...
 */
package org.kauriproject.launcher;
...
public class RuntimeLauncher {
    ...
    public RuntimeHandle run() {
        ClassLoader classLoader = LauncherClasspathHelper.getClassLoader("org/kauriproject/launcher/classloader.xml", new File(repositoryLocation));

        ClassLoader oldContextClassLoader = Thread.currentThread().getContextClassLoader();
        Object runtime;
        try {
            Thread.currentThread().setContextClassLoader(classLoader);
            Class runtimeHelperClass = classLoader.loadClass("org.kauriproject.runtime.KauriRuntimeHelper");
