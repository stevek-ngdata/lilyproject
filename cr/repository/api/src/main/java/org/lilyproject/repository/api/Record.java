...
public interface Record {
     ...
     *
     * @param parentRecords a stack of parent records of the record used to check if the record
     *                      is nested in itself or one of its parents.
     * @throws RecordException when the record is contained in the parentRecords map or if
