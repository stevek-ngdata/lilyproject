...
public class MapReduceTest {
    ...
    private long getTotalLaunchedMaps(Job job) throws InterruptedException, IOException {
        return job.getCounters().findCounter("org.apache.hadoop.mapred.JobInProgress$Counter", "TOTAL_LAUNCHED_MAPS").getValue();
    }
    
    private long getTotalInputRecords(Job job) throws InterruptedException, IOException {
